...
module "aviatrix_controller_azure" {
    ...
    log_analytics_workspace_id                     = "12345678-1234-1234-1234-123456789abc"     # Optional; if not specified creates a Log Analytics Workspace
    log_analytics_workspace_sku                    = "Free/PerNode/Premium/Standard/Standalone/Unlimited/CapcityReservation/PerGB2018"    # Optional; defaults to Free. Can only be specified if variable log_analytics_workspace_id is not specified
    log_analytics_workspace_retention_in_days      = 7     # Optional; defaults to 7 days. If variable log_analytics_workspace_sku is specified to any value different than "Free" this value must be between 30 and 730
    log_analytics_workspace_daily_quota            = 0.5 # Optional; defaults to 0.5GB. If variable log_analytics_workspace_sku is specified to any value different than "Free" this value must be an integer number
