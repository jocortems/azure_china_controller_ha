...
locals {
  ...
  argument = format("'%s' '%s' '%s' '%s' '%s' '%s' '%s' '%s' '%s' '%s' '%s' '%s' '%s' '%s' '%s' '%s'",
    ...
    var.aviatrix_customer_id, var.controller_version, var.storage_account_name, var.storage_account_container, var.storage_account_region, var.multiple_backup
  )
}
