...
def create_access_account(
    ...
    data = {
        ...
        "account_email": account_email,
        "arm_china_subscription_id": arm_subscription_id,
        "arm_china_application_endpoint": arm_application_endpoint,
        "arm_china_application_client_id": arm_application_client_id,
        "arm_china_application_client_secret": arm_application_client_secret,
    }
